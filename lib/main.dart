...
//       home: Scaffold(
//         appBar: AppBar(
//           title: const Text('10x10 Grid Game'),
//           centerTitle: true,
//         ),
//         body: Padding(
//           padding: EdgeInsets.only(
//               top: 8, left: (MediaQuery.of(context).size.width - 400) / 2),
//           child: SizedBox(
//             width: 400,
//             height: 400,
...
//                 childAspectRatio: 1,
//               ),
//               itemCount: 100, // Total number of cells (10x10)
//               itemBuilder: (BuildContext context, int index) {
//                 // Here you can customize each cell
//                 return GridTile(
//                   child: Container(
...
//   List<List<bool>> vis =
//       List.generate(12, (_) => List.filled(12, false));
...
//             child: Padding(
//               padding: EdgeInsets.only(
//                   top: 10, left: (MediaQuery.of(context).size.width - 400) / 2),
//               child: SizedBox(
//                 height: 400,
//                 width: 400,
//                 child: Stack(
